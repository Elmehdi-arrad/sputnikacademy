...
if(isset($_POST['submit'])){
	...
	$stm = $db->prepare('UPDATE categorie SET Nom_cat=? ,  type_cat=? WHERE id_cat=?');

 $stm->execute([$_POST['Nom_cat'],$_POST['type_cat'], $_GET['id']]);
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Modifier une Categorie par admin</h2>
						<div class="box-icon">
				...
				$stm = $db->prepare('select  Nom_cat , type_cat from categorie WHERE 	id_cat="'.$_GET['id'].'"');
						    $stm->execute();
						    foreach($stm->fetchAll() as $row)
						    { ?>

						<div class="styled-input">
							<input type="text" placeholder="Nom Categorie " name="Nom_cat" value="<?php echo $row['Nom_cat']; ?> "  required>
						</div>
						<div class="styled-input">
							<input type="text" placeholder="type du categorie" name="type_cat" value="<?php echo $row['type_cat']; ?> " required>
						</div>
