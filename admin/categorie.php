...
{
	$stm = $db->prepare('delete from categorie where id_cat=?');
    $stm->execute([$_GET['id']]);
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  ?>
							<tr>
		    					...
		    					<td class="center"><?php echo $row['type_cat']; ?></td>
								
								<td class="center">
									

										<a class="btn btn-default btn-lg" href="edit_cat.php?id=<?php echo $row['id_cat']; ?>">
										<i class="fa fa-refresh fa-spin" title="Modifier" style="color:black;"></i>  
									</a>

								<a class="btn btn-default btn-lg" href="?action=delete&id=<?php echo $row['id_cat']; ?>">
