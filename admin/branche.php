...
{
	$stm = $db->prepare('delete from branche where id_br=?');
    $stm->execute([$_GET['id']]);
			...
			<div class="row-fluid sortable">
				...
				<div class="box span12">
					<div class="box-header " data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Branche</h2>
						<div class="pull-right">
							<a href="add_br.php">Ajouter</a>
						</div>
					</div>
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  ?>
							<tr>
								<td><?php echo $row['Nom_br'] ;?></td>
		    					
								
								<td class="center">
									

										<a class="btn btn-default btn-lg" href="edit_br.php?id=<?php echo $row['id_br']; ?>">
										<i class="fa fa-refresh fa-spin" title="Modifier" style="color:black;"></i>  
									</a>

								<a class="btn btn-default btn-lg" href="?action=delete&id=<?php echo $row['id_br']; ?>">
