...
$stm = $db->prepare('INSERT INTO `categorie`(`Nom_cat`, `type_cat`) VALUES(?,?)');

		
			
  		 	$stm->execute([$_POST['Nom_cat'],$_POST['type_cat']]);  
				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="fields-grid">
						<div class="styled-input">
							<input type="text" placeholder="Nom Categorie " name="Nom_cat" required>
						</div>
						<div class="styled-input">
							<input type="text" placeholder="Ville" name="type_cat" required>
						</div>
