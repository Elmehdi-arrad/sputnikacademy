...
$stm = $db->prepare('INSERT INTO `branche`(`Nom_br`) VALUES(?)');

		
			
  		 	$stm->execute([$_POST['Nom_br']]);  
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Ajouter une Branche par admin</h2>
						<div class="box-icon">
				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="fields-grid">
						<div class="styled-input">
							<input type="text" placeholder="Nom Branche " name="Nom_br" required>
						</div>
